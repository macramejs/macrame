...
import { FunctionalComponent, Plugin, WatchSource } from 'vue'
...
export declare function useForm<TItem = Model>(route: string, model: TItem, options?: Macrame.UseFormOptions) : TMacrameForm<TItem>;
